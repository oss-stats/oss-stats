...
$packages = @(
    ...
    'Cake.AppPackager',             'Cake.AppVeyor',                    'Cake.APT.Module',              'Cake.ArgumentHelpers',
    'Cake.AssemblyInfoReflector',   'Cake.AutoRest',                    'Cake.AWS.CloudFront',          'Cake.AWS.CodeDeploy',
    'Cake.AWS.EC2',                 'Cake.Aws.ElasticBeanstalk',        'Cake.AWS.ElasticLoadBalancing','Cake.AWS.Lambda',
    'Cake.AWS.Route53',             'Cake.AWS.S3',                      'Cake.AzCopy',                  'Cake.Azure',
    'Cake.AzureBlobStorage',        'Cake.AzureStorage',
    ...
    'Cake.MsDeploy',
    'Cake.Netlify',                 'Cake.Newman',                      'Cake.NewRelic',                'Cake.Npm',
    'Cake.NSpec',                   'Cake.NSwag',                       'Cake.NSwag.Console',           'Cake.Nuget.Versioning',
    ...
    'Cake.Prca.Issues.Markdownlint','Cake.Prca.Issues.MsBuild',         'Cake.Prca.PullRequests.Tfs',   'Cake.ProjHelpers',
    'Cake.ProtobufTools',           'Cake.Putty',
    ...
    'Cake.SynVer',
    'Cake.Talend',                  'Cake.Terraform',                   'Cake.Tfs.Build.Variables',     'Cake.Tfx',
    'Cake.Topshelf',,               'Cake.Transifex',               'Cake.Twitter',
