...
$packages = @(
    ...
    'Cake.Curl',
    'Cake.DeployParams',            'Cake.DevicesXunitTestReceiver',    'Cake.Dialog',                  'Cake.DNF.Module',
    'Cake.DocCreator',              'Cake.DocFx',                       'Cake.Docker',                  'Cake.DocumentDb',
    'Cake.DoInDirectory',           'Cake.DotNetCoreEf',
