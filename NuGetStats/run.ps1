...
$packages = @(
    ...
    'Cake.ArgumentHelpers',         'Cake.AssemblyInfoReflector',       'Cake.AutoRest',                'Cake.AWS.CloudFront',
    'Cake.AWS.CodeDeploy',          'Cake.AWS.EC2',                     'Cake.Aws.ElasticBeanstalk',    'Cake.AWS.ElasticLoadBalancing',
    'Cake.AWS.Lambda',              'Cake.AWS.Route53',                 'Cake.AWS.S3',                  'Cake.AzCopy',
    'Cake.Azure',                   'Cake.AzureBlobStorage',            'Cake.AzureStorage',
